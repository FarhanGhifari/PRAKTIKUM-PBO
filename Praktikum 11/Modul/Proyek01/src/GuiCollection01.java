...
// Tanggal      : 21 Mei 2025
// File         : GuiCollection01.java
// Deskripsi    : Implementasi GUI untuk proyek0-1
 ...
 */
public class GuiCollection01 extends javax.swing.JFrame {

    DefaultListModel<String> dlm;
    /**
     * Creates new form GUI
     */
    public GuiCollection01() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuiCollection01.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GuiCollection01().setVisible(true);
            }
        });
    }
